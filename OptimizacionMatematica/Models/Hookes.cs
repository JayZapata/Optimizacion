...
namespace OptimizacionMatematica.Models
{
    ...
    public class Hookes
    {
        ...
        protected double MyFxEx(int nNumVars, ref double[] fX, ref double[] fParam, ref double[] fDeltaX, double fLambda)
        {
            ...
            return m_MyFx(nNumVars, ref fXX);
        }
        ...
        public double CalcOptim(int nNumVars, ref double[] fX, ref double[] fParam, ref double[] fStepSize, ref double[] fMinStepSize, double tolerance, ref int nIter, MyFxDelegate MyFx)
        {
            int i;
            ...
            fBestF = MyFx(nNumVars, ref fXnew);
            ...
            do
            {
                ...
                if (Math.Abs(fBestF - fLastBestF) < tolerance)
                {
                    break;
                }
